        ...
        <ListItem>
          <Box textAlign="left" my={1}>
            <Text>
              ...
              </TextLink>{' - an app that attempts to discover and match couples based on each other\'s music taste, using technologies including React.js, Python, Django, MongoDB'}
            </Text>
          </Box>
        </ListItem>
